    ...
    <div className="relative bg-primary rounded-3xl overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="house-pattern" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
              <path
                ...
                strokeDasharray="5,5"
              />
              <circle cx="50" cy="60" r="15" stroke="white" strokeWidth="2" fill="none" strokeDasharray="5,5" />
            </pattern>
          </defs>
